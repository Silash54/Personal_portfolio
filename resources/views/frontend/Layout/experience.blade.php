            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="team-detail wow bounce" data-wow-delay="0.2s">
                        <img src="{{ asset('frontend/images/user1.jpg') }}" class="img-fluid" />
                        <h4>Nitu Singh</h4>
                ...
                <div class="col-md-4">
                    <div class="team-detail wow bounce" data-wow-delay="0.4s">
                        <img src="{{ asset('frontend/images/user2.jpg') }}" class="img-fluid" />
                        <h4>Yogesh Singh</h4>
                        <p>CEO & Founder</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="team-detail wow bounce" data-wow-delay="0.6s">
                        <img src="{{ asset('frontend/images/user3.jpg') }}" class="img-fluid" />
                        <h4>Nisha Sharma</h4>
                        <p>Web Developer</p>
                    </div>
                </div>
