                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('education.update',$education->id) }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="level" class="form-control" name="level" value="{{ old('level')?? $education->level }}" required>
                                    @error('level')
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="date" class="form-control" name="start" value="{{ old('start') ?? $education->start }}" required>
                                    @error('start')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="date" class="form-control" name="end" value="{{ old('end') ?? $education->end }}" required>
                                    @error('end')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
